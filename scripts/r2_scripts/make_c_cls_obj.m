[c_cls,target_obj,sphere_shp] = get_C_closure_object2d(file_name,robot_r,robot_corners,dots_spacing,c_cls_search_interval);  %C_cls_obj作成
...
%c_cls_outline = c_cls.Location(1:2);
%{
figure;
axis equal
