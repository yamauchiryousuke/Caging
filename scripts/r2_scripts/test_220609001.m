...
c_cls = get_C_closure_object2d(file_name,robot_r,robot_corners,dots_spacing,c_cls_search_interval);  %C_cls_obj作成
...
for i = 0:(object_Y/dcc_search_interval)+0.5
    for j = 0: 2*(object_X/dcc_search_interval)+0.5
