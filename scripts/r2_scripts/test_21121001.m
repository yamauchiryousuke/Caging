...
for str = char(sort(cellstr(properties(cc_group))))'
    ...
    for cc_group_size = 1:size(cc_group.(matlab.lang.makeValidName(str'))(:,1))
        ...
        if isempty(find(cc_group.(matlab.lang.makeValidName(str'))(:,1) == test_L(1,1) & cc_group.(matlab.lang.makeValidName(str'))(:,2) == test_L(1,2) | cc_group.(matlab.lang.makeValidName(str'))(:,1) == test_Un(1,1) & cc_group.(matlab.lang.makeValidName(str'))(:,2) == test_Un(1,2)))== 0
            %disp('true') 
    ...
    for cc_group_size = size(cc_group.(matlab.lang.makeValidName(str'))(:,1)):-1:1
        ...
        if isempty(find(cc_group.(matlab.lang.makeValidName(str'))(:,1) == test_R(1,1) & cc_group.(matlab.lang.makeValidName(str'))(:,2) == test_R(1,2) | cc_group.(matlab.lang.makeValidName(str'))(:,1) == test_Up(1,1) & cc_group.(matlab.lang.makeValidName(str'))(:,2) == test_Up(1,2)))== 0
            %disp('true') 
...
%if isempty(vb) == 0
    ...
    for vb_size = 1:size(vb(:,1))
        ...
        if isempty(find(vb(:,1) == test_L(1,1) & vb(:,2) == test_L(1,2) | vb(:,1) == test_Un(1,1) & vb(:,2) == test_Un(1,2) | vb(:,1) == test_LL(1,1) & vb(:,2) == test_LL(1,2) | vb(:,1) == test_UL(1,1) & vb(:,2) == test_UL(1,2)))== 0
            %disp('true') 
    ...
    for vb_size = size(vb(:,1)):-1:1
        ...
        if isempty(find(vb(:,1) == test_R(1,1) & vb(:,2) == test_R(1,2) | vb(:,1) == test_Up(1,1) & vb(:,2) == test_Up(1,2) | vb(:,1) == test_LR(1,1) & vb(:,2) == test_LR(1,2) | vb(:,1) == test_UR(1,1) & vb(:,2) == test_UR(1,2)))== 0
            %disp('true') 
