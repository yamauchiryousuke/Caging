...
depth_rate = 2;
    ...
    for str = char(sort(cellstr(properties(cc_group))))'
        ...
        cc_group.(matlab.lang.makeValidName(str'))(:,4)=1;
        for t = 0:5:360
        A = [1 0 0 0; ...
            0 cosd(t) -sind(t) 0; ...
            0 sind(t) cosd(t) 0; ...
            0 0 0 1];
        tform = affine3d(A);
        cc_group.(matlab.lang.makeValidName(str'))=A*cc_group.(matlab.lang.makeValidName(str')).';
        cc_group.(matlab.lang.makeValidName(str'))=cc_group.(matlab.lang.makeValidName(str')).';
        scatter3(cc_group.(matlab.lang.makeValidName(str'))(:,1),cc_group.(matlab.lang.makeValidName(str'))(:,2),cc_group.(matlab.lang.makeValidName(str'))(:,3),1*2,'filled','MarkerFaceColor','magenta','MarkerFaceAlpha', show_num/(depth_rate^cc_num));
